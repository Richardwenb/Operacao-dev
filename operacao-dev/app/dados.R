...
getFiliais <- function(){
  con <- tryCatch({ dbConnect(RMariaDB::MariaDB(), host = "192.168.235.21", user = "server", password="Trfc67.mls6c", dbname='consenso')   }, error = function(err) { return("") })
...
addDados <- function(tipo_entrada, dados){
  con <- tryCatch({ dbConnect(RMariaDB::MariaDB(), host = "192.168.235.21", user = "server",
                              password="Trfc67.mls6c", dbname='consenso')   }, error = function(err) { return("") })
